...
bring-up may use pid.codes' `0x1209:0x0002` test pair with the device operator's
...
At this early enumeration checkpoint, the WEMOS S2 Mini tests had not yet established:
...
Later S2 transport and credential results are summarized in the
[S2 test report](../testing/esp32s2-results.md).
