...
#[cfg(test)]
#[allow(dead_code)]
// The vendor crate owns this file's edition and formatting configuration.
#[rustfmt::skip]
#[path = "../../../third_party/fido-authenticator/src/ctap2/pin.rs"]
mod pin;
#[cfg(test)]
mod pin_lifecycle;
