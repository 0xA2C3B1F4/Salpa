    ...
    environment.update(
        {
            ...
            "RISSO_KEY_SIGNED_AB_BOOTLOADER": "1",
        }
    )
...
def validate_sdkconfig(path: Path, key_digest: str, protected_external: bool) -> None:
...
def main() -> int:
    ...
    try:
        ...
        validate_sdkconfig(sdkconfig, key_digest, args.protected_external)
        ...
        manifest = {
            ...
            "warning": (
                "Booting this protected configuration before completing the "
