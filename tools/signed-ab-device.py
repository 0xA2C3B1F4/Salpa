...
def read_region(python: Path, port: str, offset: int, size: int) -> bytes:
    with tempfile.TemporaryDirectory(prefix="salpa-ab-read-", dir=temporary_root()) as directory:
...
def stage(args: argparse.Namespace) -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="salpa-ab-entry-", dir=temporary_root()) as directory:
